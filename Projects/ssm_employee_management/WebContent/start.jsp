	...
	<div class="row-fluid">
		<div class="col-md-2" style="padding-left: 0px;">
			<div class="well menuSideBar" style="padding: 8px 0px;">
				<ul class="nav nav-list" id="menuSideBar">
					...
					<%--href="javascript:void(0)" 不进行跳转   走funurl路线 --%>					
					<li mid="tab1" funurl="<%=path %>/deptController/findAll"><a tabindex="-1" href="javascript:void(0)">部门管理</a></li>
					<li mid="tab2" funurl="<%=path %>/employeeController/findAll"><a tabindex="-1" href="javascript:void(0)">员工管理</a></li>
					<li mid="tab3" funurl="<%=path%>/historyController/findAll"><a tabindex="-1" href="javascript:void(0)">员工变更管理</a></li>
				</ul>
			</div>
		</div>
		<div class="col-md-10" id="mainFrameTabs" style="padding:0px;">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="bTabs-navTabsMainPage">
					<div class="page-header">
					<h2 style="font-size:31.5px;text-align: center;font-weigth:normal;line-height:60px;">
					欢迎使用<br>
					公司人事后台管理系统
					</h2>
					</div>
...
<div style="text-align: center;margin:100px;font:normal 14px/24px 'MicroSoft YaHei';">
	<p>360、FireFox、Chrome、Opera、傲游、搜狗、世界之窗. 不支持IE8及以下浏览器</p>
</div>
</body>
</html>